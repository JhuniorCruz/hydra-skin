    ...
    <div className="container mx-auto px-6">
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] gap-10 items-start">
          <article className="rounded-2xl border border-hydra-dark/10 bg-hydra-bg p-8 md:p-10 shadow-[0_16px_40px_rgba(0,0,0,0.08)]">
          ...
          <article className="rounded-2xl border border-hydra-dark/10 p-8 md:p-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {credentials.map((credential) => (
                <div key={credential} className="rounded-xl bg-hydra-bg border border-hydra-dark/10 px-4 py-3">
        ...
        <article className="mt-10 rounded-2xl border border-hydra-dark/10 p-8 md:p-10">
          <h3 className="text-3xl font-serif text-hydra-dark mb-8">Por que elegirnos</h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {trustPillars.map((pillar) => (
              <div key={pillar.title} className="rounded-xl bg-hydra-bg p-6 border border-hydra-dark/10">
