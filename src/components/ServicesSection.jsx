...
const serviceCategories = ["Faciales", "Corporales", "Tecnologicos"];
          ...
          >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[1.15fr_0.85fr] max-h-[88vh]">
              ...
              <div className="flex flex-col p-6 sm:p-8 lg:p-10 overflow-y-auto">
                <p className="text-[11px] uppercase tracking-[0.2em] text-hydra-dark/50 mb-4">{selectedService.category}</p>
                ...
                <p className="text-sm sm:text-base leading-relaxed text-hydra-dark/80 mb-4">{selectedServiceDescription}</p>
                <p className="text-sm leading-relaxed text-hydra-dark/70">
                  <span className="font-semibold text-hydra-dark">Resultado esperado:</span> {selectedService.expectedResult}
                </p>
    ...
    <section id="servicios" className="py-24 bg-hydra-beige relative" data-aos="fade-up">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center mb-12">
          <span className="text-sm font-bold uppercase tracking-wide mb-3 block text-hydra-dark/70">
            Catalogo inteligente
          </span>
          <h2 className="text-4xl font-serif text-hydra-dark">Rituales de renovacion para tu piel</h2>
          <p className="text-sm text-hydra-dark/70 max-w-2xl mx-auto mt-4">
            Filtra por categoria para encontrar el protocolo ideal segun tu objetivo.
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
            {filteredServices.map((svc) => (
              ...
              >
                ...
                <p className="text-sm leading-relaxed mb-4 text-gray-600 group-hover:text-white/80">{svc.description}</p>
                <p className="text-sm leading-relaxed mb-6 text-hydra-dark/80 group-hover:text-white/85">
                  <span className="font-semibold">Resultado esperado:</span> {svc.expectedResult}
                </p>
